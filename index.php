...
<html>
  <head>
    ...
    <title>James L. Benjamin | Web Designer & Developer - JavaScript, HTML, PHP, CSS, MySQL</title>
    <meta name="description" content="Web Designer  Web Developer Programming languages: JavaScript, HTML, PHP, CSS, Java, XML, Ajax, JQuery, MySQL, E-Commerce, Website, Bootstrap">
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="img/jblogo.png">
  ...
  <body>
    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container"><a href="#intro" class="navbar-brand scrollTo">James L.B.</a>
    ...
    <section id="intro" style="background: url(img/home.jpg) center center no-repeat; background-size: cover;" class="intro-section pb-2">
      <div class="container text-center">
        <div data-animate="fadeInDown" class="logo"><img src="img/jblogo.png" alt="logo" width="130"></div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div data-animate="fadeInUp" class="col-lg-6">
            <p>
			I am a freelance web designer and developer based in New Jersey, USA. Highly experienced in a variety of web technologies. My bread and butter is PHP and it's associated stack. I'm comfortable using raw PHP for all sorts of projects: full CMS projects,  database-driven web applications, e-commerce sites... Besides PHP I am also proficient in HTML, CSS, Javascript, Java, Ajax, JQuery, MySQL, XML and Bootstrap.</p>
			<p>
			Since the beginning of my career, I’ve focused on channeling my talent and creativity into meaningful and powerful results. I take pride in the work I do, as well as the strong relationships I’ve built with clients and colleagues. I firmly believe in working hard, working together and having fun along the way. If you’re interested in learning more about me or my work, simply reach out.
						</p>
          </div>
          <div data-animate="fadeInUp" class="col-lg-6">
            ...
            <div class="skill-item">
              ...
              <div class="progress">
                <div role="progressbar" style="width: 70%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" class="progress-bar progress-bar-skill4"></div>
              </div>
            </div>
            <div class="skill-item">
      ...
      <div class="container">
        ...
        <div class="row services text-center">
          <div data-animate="fadeInUp" class="col-lg-4">
            ...
            <p class="text-left description">I will provide any type of consultion regarding web design, web application, integretions, hosting, etc... I can guide you through the world wide web and how to make the most out of it. </p>
          </div>
          <div data-animate="fadeInUp" class="col-lg-4">
            <div class="icon"><i class="fa fa-html5"></i></div>
            <h3 class="heading mb-3 text-400">Web Design</h3>
            <p class="text-left description">I know I can help you or your company create stunning visuals. As someone who has worked in marketing and graphic design for almost a decade, I know what brands need to capture their audiences' attention. With my powerful design skills and knack for marketing, I have the right background for your brand's needs.</p>
          </div>
          <div data-animate="fadeInUp" class="col-lg-4">
            <div class="icon"><i class="fa fa-tachometer"></i></div>
            <h3 class="heading mb-3 text-400">Web Development</h3>
            <p class="text-left description">I enjoy building everything from small business applications to rich interactive web apps. If you are a business seeking a web presence or an employer looking to hire, you can get in touch with me.</p>
          </div>
        </div>
        ...
        <div class="row showcase text-center"> 
          <div data-animate="fadeInUp" class="col-lg-3 col-md-6">
            <div class="item">
              ...
              <h5 class="text-400 mt-4 text-uppercase"><span class="counter">53</span><br>Websites</h5>
            </div>
          </div>
          <div data-animate="fadeInUp" class="col-lg-3 col-md-6">
            <div class="item">
              <div class="icon"><i class="fa fa-users"></i></div>
              <h5 class="text-400 mt-4 text-uppercase"><span class="counter">133</span><br>Satisfied Clients</h5>
            </div>
          </div>
          <div data-animate="fadeInUp" class="col-lg-3 col-md-6">
            <div class="item">
              <div class="icon"><i class="fa fa-copy"></i></div>
              <h5 class="text-400 mt-4 text-uppercase"><span class="counter">257</span><br>Projects</h5>
            </div>
          </div>
          <div data-animate="fadeInUp" class="col-lg-3 col-md-6">
            <div class="item">
              <div class="icon"><i class="fa fa-font"></i></div>
              <h5 class="text-400 mt-4 text-uppercase"><span class="counter">33</span><br>Businesses</h5>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 text-center text-lg-left">
            <p class="social"><a href="#" data-wow-delay="0.6s" class="email wow fadeInUp"><i class="fa fa-envelope"></i></a></p>
          </div>
          <!-- /.6-->
          <div class="col-md-6 text-center text-lg-right mt-4 mt-lg-0">
            <p>©2021 James L. Benjamin. All rights reserved.</p>
          </div>
